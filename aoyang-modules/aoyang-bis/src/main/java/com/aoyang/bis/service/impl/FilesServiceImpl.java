...
public class FilesServiceImpl extends ServiceImpl<FilesMapper, Files> implements FilesService {
    ...
    public Result<?> addFile(HttpServletRequest request, MultipartFile file, CurrentUserInfo userInfo) throws IOException {
        ...
        files.setCreatePersonId(userInfo.getUserid());
